...
<head>
    ...
    <title>Absensi IndonesiaSejahtera</title>
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="../assets/img/sidebar-5.jpg" data-color="gray">
            <!--
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/Sample.jpg') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                           <center> &copy; 2020 <a>PKL Cikara 2020</a></center>
                        </p>
                    </nav>
                </div>
            </footer>
